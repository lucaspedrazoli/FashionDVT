...
class IssueSixGalleyViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
  @IBOutlet weak var collectionView: UICollectionView!
  let images: [UIImage?] = [UIImage(named: "pauta6_photo1"),UIImage(named: "pauta6_photo2"),UIImage(named: "pauta6_photo3"),UIImage(named: "pauta6_photo4"),UIImage(named: "pauta6_photo5"),UIImage(named: "pauta6_photo6"),UIImage(named: "pauta6_photo7"),UIImage(named: "pauta6_photo8")]
  ...
  override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
    let destination = segue.destination as! IssueSixPhotoViewController
