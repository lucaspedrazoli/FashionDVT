...
class IssueTwoGalleryViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
  
  @IBOutlet weak var collectionView: UICollectionView!
  let images: [UIImage?] = [UIImage(named: "pauta2_photo3"),UIImage(named: "pauta2_photo4"),UIImage(named: "pauta2_photo5")]
